...
describe("analyseOfferFit", () => {
  it("prioriza una oferta con coincidencia profesional, geográfica y lingüística", () => {
  ...
  it("visibiliza los requisitos que no aparecen en el perfil y reduce la prioridad", () => {
    const analysis = analyseOfferFit(profile, {
